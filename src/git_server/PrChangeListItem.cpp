...
PrChangeListItem::PrChangeListItem(DiffChange change, const QString &style, QWidget *parent)
   : QFrame(parent)
...
void PrChangeListItem::openReviewDialog(int line)
{
   ...
   const auto dlg = new AddCodeReviewDialog(ReviewMode::Comment, mStyle);
