...
void PrCommitsList::onCommitsReceived(const GitServerPlugin::PullRequest &pr)
{
...
QFrame *PrCommitsList::createBubbleForComment(const GitServerPlugin::Commit &commit)
{
