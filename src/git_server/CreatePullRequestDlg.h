...
private:
    ...
    */
   void onMilestones(const QVector<GitServerPlugin::Milestone> &milestones);
   /**
    ...
    */
   void onLabels(const QVector<GitServerPlugin::Label> &labels);
   /**
    ...
    * link to the PR.
    */
   void onPullRequestUpdated(const GitServerPlugin::PullRequest &pr);
   /**
