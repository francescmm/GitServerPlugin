...
public:
    ...
    */
   explicit MergePullRequestDlg(const QSharedPointer<GitBase> git, GitServerPlugin::ConfigData data,
                                const GitServerPlugin::PullRequest &pr, const QString &sha, QWidget *parent = nullptr);
   /**
    * Destructor
    */
   ~MergePullRequestDlg();
...
private:
   ...
   GitServerPlugin::PullRequest mPr;
   QString mSha;
   GitServerPlugin::IRestApi *mApi;
