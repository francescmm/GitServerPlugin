...
signals:
    ...
    */
   void labelsReceived(const QVector<GitServerPlugin::Label> &labels);
   /**
    ...
    */
   void milestonesReceived(const QVector<GitServerPlugin::Milestone> &milestones);

   /**
    * @brief issuesReceived Signal triggered when the issues has been received.
    * @param issues The list of issues.
    */
   void issuesReceived(const QVector<GitServerPlugin::Issue> &issues);

   /**
    * @brief pullRequestsReceived Signal triggered when the pull requests has been received.
    * @param prs The list of prs.
    */
   void pullRequestsReceived(const QVector<GitServerPlugin::PullRequest> &prs);
    ...
    */
   void commentsReceived(int issueNumber, const QVector<GitServerPlugin::Comment> &comments);
    ...
    */
   void codeReviewsReceived(int prNumber, const QVector<GitServerPlugin::CodeReview> &codeReviews);
    ...
    */
   void commentReviewsReceived(int prNumber, const QMap<int, GitServerPlugin::Review> &commentReviews);
    ...
    */
   void commitsReceived(int prNumber, const QVector<GitServerPlugin::Commit> &commits, int currentPage, int lastPage);

   /**
    * @brief pullRequestUpdated Signal triggered when a pull request has been updated.
    * @param pr The updated pull request.
    */
   void pullRequestUpdated(const GitServerPlugin::PullRequest &pr);
